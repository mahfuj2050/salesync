...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
	...
	Payment findByTrnRefNo(String trnRefNo);
...
//    	                             Pageable pageable);
    ...
    @Query("SELECT p FROM Payment p WHERE " +
            "(:search IS NULL OR p.fromAccount LIKE %:search% OR p.toAccount LIKE %:search%) AND " +
            "(:refType IS NULL OR p.refType = :refType) AND " +
